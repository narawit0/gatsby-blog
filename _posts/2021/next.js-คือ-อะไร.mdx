...
date: 2021-12-28
tags: [Framework]
excerpt: Next.js คืออะไร อธิบายแบบเห็นภาพคร่าวๆ แบบกระทัดรัด....
cover: ../images/next.js.png
---
![](../images/next.js.png)
...
และจะถูกมองว่าเป็น `Api Endpoint` แทนที่จะเป็น `Page` ในส่วนของ `Api Endpoint` นั้นจะอยู๋ในฝั่งของ server-side เท่านั้น
