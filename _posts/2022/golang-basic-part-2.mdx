...
จากในบทความก่อนหน้านี้ เราได้เกริ่นถึง Basic Syntax ในภาษา Go ไปแล้ว สามารถย้อนไปดูได้ใน [Basic Golang Part 1](https://narawit.dev/2022/golang-basic-part-1/)
ในความนี้ เราจะมาพูดถึงสิ่งที่มัน Advanced ขึ้นมาสักนิดนึงเทียบจากบทที่แล้วนะครับ
