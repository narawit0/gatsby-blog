...
จากในบทความก่อนหน้านี้ เราได้เกริ่นถึง Basic Syntax ในภาษา Go ไปแล้ว สามารถย้อนไปดูได้ใน [Golang Basic Part 1](https://narawit.dev/2022/golang-basic-part-1/)
