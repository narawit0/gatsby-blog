...
date: 2022-02-24
tags: [Go]
excerpt: ภาษา Go หรือว่า Golang เป็นภาษาในฝั่งของ Server Side ที่ถูกสร้างขึ้นเมื่อปี 2007 โดย Google และได้มีการเผยแพร่ออกมาให้เหล่า Developers ได้ใช้กันในปี 2009...
cover: ../images/basic-golang-part-1.png
---
![](../images/golang-basic-part-1.png)
> [Basic Golang Part 1](https://narawit.dev/2022/basic-golang-part-1/) - Basic Syntax

> [Basic Golang Part 2](https://narawit.dev/2022/basic-golang-part-2/) - Pointers, Structs, Slices, Maps, Functions

> [Basic Golang Part 3](https://narawit.dev/2022/basic-golang-part-3/) - Interfaces, Methods, Goroutines
