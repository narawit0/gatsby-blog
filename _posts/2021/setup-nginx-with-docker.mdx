---
title: วิธีการ Setup Nginx ด้วย Docker's Nginx Image
date: 2021-09-04
tags: [Docker]
excerpt: ขอเกริ่นคร่าวๆก่อนว่า โดยปกติแล้วถ้าเราจะ นำโปรเจ็กต์ของเรา ขึ้นไปอยู่บนเว็บสักเว็บนึง สิ่งที่เราจะต้องทำคือ...
cover: ../images/docker-nginx.png
---
